...
public:
	...
	Game2();
	Game2(const Board& board, const Player& currentPlayer, const std::vector<Player> players, const std::vector<Question>& Questions, const std::vector<QuestionMultipleChoice>& QuestionsMultipleChoice);
