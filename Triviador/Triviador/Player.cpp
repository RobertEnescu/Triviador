...
Player::Player(const std::string& username, const std::string& password, const Profile& profile, const Advantages& advantages)
    :m_username(username),
    m_password(password),
    m_profile(profile),
...
const Profile& Player::GetProfile() const
{
    return m_profile;
}
